...
branch_checkout_node = SpaceKeyNode(
    "c", "checkout", None, lambda: logger.info("invoke checkout")
)
branch_delete_node = SpaceKeyNode(
    "d", "delete", None, lambda: logger.info("invoke delete")
)
branch_node = SpaceKeyNode(
    "b", "branch", [branch_checkout_node, branch_delete_node], None
)
push_node = SpaceKeyNode("p", "push", None, lambda: logger.info("invoke push"))
git_node = SpaceKeyNode("g", "git", [push_node, branch_node], None)
